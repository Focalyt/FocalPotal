...
const {updateSpreadSheetStartCarrerValues} = require("./services/googleservice");
...
router.post('/',async (req, res) => {
  try {
    ...
    const { fullname, location, mobile, email, position ,experience } = req.body;
    console.log("Form Data:", req.body);
    // Capitalize every word's first letter
    
    if(!fullname || !location || !mobile|| !email || !position || !experience){
        req.flash("success", "Please fill all fields");
            return res.redirect("/courses");
    }
    const response_key = req.body["g-recaptcha-response"];
    ...
    await updateSpreadSheetStartCarrerValues(sheetData);
    ...
    `https://www.google.com/recaptcha/api/siteverify?secret=${secret_key}&response=${response_key}`;
      fetch(url, {
        ...
        .then((google_response) => {
            console.log('====================> ', google_response)
          if (google_response.success == true && google_response.score >=0.5) {
            let subject = " Carrer with Focalyt: New Demo Request";
            let msg = `<html lang="en">
            <head>
            <meta charset="utf-8">
            <meta name="viewport" content="width=device-width, initial-scale=1">
                                                      ...
                                                      <tbody>
                                                          ...
                                                          <tr>
                                                              <td align="left" style="font-family:'Manrope',sans-serif!important">
                                                                  ...
                                                                  <li style="padding-top:0px;margin-left:0px !important"><span
                                                                              style="line-height:32px;font-size:18px!important;font-family:'Manrope',sans-serif!important">
                                                                              User Name:- ${fullname} (${mobile}) </span></li>
                                                                      <br/>
                                                                      ...
                                                                      <li style="padding-top:0px;margin-left:0px !important"><span
                                                                              style="line-height:32px;color:#4d4d4d;font-size:18px!important;font-family:'Manrope',sans-serif!important">Message : ${position}
                                                                          </span></li>
                                                                           <li style="padding-top:0px;margin-left:0px !important"><span
                                                                              style="line-height:32px;color:#4d4d4d;font-size:18px!important;font-family:'Manrope',sans-serif!important">Message : ${experience}
                                                                          </span></li>
                                                                      <br/>
